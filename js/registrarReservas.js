...
function registrar() {
    ...
    if (validar()){
        $.ajax({
            ...
            url: "http://152.70.124.95:8080/api/Reservation/save",
...
function listarClientes() {
    $.ajax({
        // la URL para la petición (url: "url al recurso o endpoint")
        url: "http://152.70.124.95:8080/api/Client/all",
...
function armaListaDisfraces(items) {
    ...
    //define variable javascript con la definicion inicial de la tabla, la primera fila y los
    //encabezados o títulos de la tabla
    var lista = ` <option value="">--Selecciona una Finca--</option>`;
...
function listarDisfraces() {
    $.ajax({
        // la URL para la petición (url: "url al recurso o endpoint")
        url: "http://152.70.124.95:8080/api/Farm/all",
